...
model_args = st.sidebar.text_input(
    "model args", "/mnt/bn/research-hl/ckpts/flan_2022.llama13B.fix/args.json"
)
model_ckpt = st.sidebar.text_input(
    "model ckpt", "/mnt/bn/research-hl/ckpts/flan_2022.llama13B.fix/checkpoint-10000"
)
...
load_model_bttn = st.sidebar.button(
    "load model", on_click=get_engine, args=(model_args, model_ckpt)
)

lengths = st.sidebar.text_input(
    "lengths", "50 "
)  # st.sidebar.number_input("length", value=100)
