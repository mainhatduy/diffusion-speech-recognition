...
Usage:
  uv run python scripts/qualcomm-job/test_local_inference.py --mode both
  uv run python scripts/qualcomm-job/test_local_inference.py --mode onnx --audio test/test_data/test_sample.mp3
"""
...
def prepare_audio_inputs(audio: np.ndarray, stride: int = 80) -> dict:
    """Prepare audio inputs for the audio_encoder."""
