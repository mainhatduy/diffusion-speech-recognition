...
def main():
    if len(sys.argv) < 2:
        print("Usage: python scripts/model-manager/push_checkpoint.py <repo_id> [checkpoint_dir] [repo_type]")
        print("Example: python scripts/model-manager/push_checkpoint.py aiai-laboratory/discrete-diffusion-vi-multitask-checkpoint outputs/vi_multitask/checkpoint-60000")
        sys.exit(1)
    ...
    meta_files = ["args.json", "tokenizer.json", "tokenizer_config.json", "special_tokens_map.json"]
